...
##########################################################################################################
            ...
            print(str(speed_backward) + "d    " + str(speed_forward) + "c   " + str(speed_down) + "b  " + str(speed_up) + "a  " + str(speed_down) + "e  " + str(speed_up) + "f  ")
###########################################################################################################
            ...
            speed_up_1 = myround(translate(p_position, -1,1,1600,1400)) #pitch up (FORMERLY 1300-1700 AS OF 10/6/25)
            if int(speed_up_1) != a_recent_speed:
                current_time = time.time()
                if current_time > last_send_time + SEND_EVERY:
                    last_send_time = current_time
            ...
            speed_down_1 = myround(translate(p_position,1,-1,1600,1400)) #pitch down (FORMERLY 1300-1700 AS OF 10/6/25)
            if int(speed_down_1) != b_recent_speed:
                current_time = time.time()
                if current_time > last_send_time + SEND_EVERY:
                    last_send_time = current_time
            ...
            speed_forward = myround(translate(s_position,-1,1,1400,1600)) #turn right (FORMERLY 1300-1700 AS OF 10/6/25)
            if int(speed_forward) != c_recent_speed:
                current_time = time.time()
                if current_time > last_send_time + SEND_EVERY:
                    last_send_time = current_time
            ...
            # was previously [1400, 1500]
            speed_backward = myround(translate(s_position, 1,-1,1400,1600)) #turn left (FORMERLY 1300-1700 AS OF 10/6/25)
            if int(speed_backward) != d_recent_speed:
                current_time = time.time()
                if current_time > last_send_time + SEND_EVERY:
                    last_send_time = current_time
